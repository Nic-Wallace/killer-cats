...
def welcome():
    ...
    "opposable thumbs\nand ammunition. Keep your wits about you survivor, and "
...
def dirt_path():
    ...
    "It seems like\nevening, and the light is fading as you quickly try to "
    "find safety.")
...
def hillside():
    ...
    while True:
        ...
        if answer.strip() == "1":
            ...
            " he sees you,\nthen looks to his left where you see a platoon of"
            " cats rushing in.")
...
def camp():
    ...
    "trickling stream.\nYou get a fresh, cold drink before heading towards "
    "the smoke.")
    ...
    'another survivor.\nWe are actually on our way to a secure settlement '
    ...
    "world.\nThe Great Cat War wiped out a lot of humanity, and almost all "
    "dogs.")
    print("As you walk and talk, you are alarmed by rustling in the bushes to"
    " the right of\nyour path. The others draw their weapons and motion to "
    "you that you do the same.")
