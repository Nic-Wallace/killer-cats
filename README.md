...
[Killer Cats](https://killer-cats-7c9a42c7f6ca.herokuapp.com) is a text-based adventure game where the objective is to stay alive. After a description of the players surroundings, 
